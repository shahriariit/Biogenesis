...
public class MainWindow extends JFrame {
	...
	public boolean _isProcessActive=false;
	...
	public StdAction abortTrackingAction;
	...
	public JToolBar toolBar = new JToolBar(Messages.getString("T_PROGRAM_NAME")); //$NON-NLS-1$
	...
	public Organism _trackedOrganism = null;
...
//	 Comptador de frames, per saber quan actualitzar la finestra d'informaci�
	...
	class OpenGameAction extends StdAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				chooser.setFileFilter(new BioFileFilter(BioFileFilter.WORLD_EXTENSION));
	...
	protected void about() {
		ImageIcon imageIcon = new ImageIcon(getClass().getResource("images/bullet.jpg")); //$NON-NLS-1$
		...
		+Messages.getString("T_VERSION")+ //$NON-NLS-1$ 
				...
				Messages.getString("T_ARTWORK_BY")+" Ananda Daydream";  //$NON-NLS-1$//$NON-NLS-2$
	...
	private void setControls () {
        ...
        infoToolbar = new InfoToolbar(null, _visibleWorld);
	...
	public File saveObjectAs(Object obj) {
		...
		try {
			JFileChooser chooser = new JFileChooser();
			chooser.setFileFilter(new BioFileFilter(obj));
